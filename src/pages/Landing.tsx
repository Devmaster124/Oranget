    ...
    <div className="min-h-screen relative font-titan overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-start justify-center min-h-[80vh] p-12">
        <div className="max-w-2xl">
          <h1
            className="text-9xl text-white font-titan mb-8 drop-shadow-lg"
            style={{ fontWeight: "400" }}
          >
            Oranget
          </h1>
          ...
          <h2
            className="text-4xl text-white font-titan mb-6 drop-shadow-lg"
            style={{ fontWeight: "400" }}
          >
          ...
          <p
            className="text-xl text-orange-100 font-titan mb-12 max-w-lg leading-relaxed drop-shadow-lg"
            style={{ fontWeight: "400" }}
          >
            Join thousands of players in the ultimate Blooket experience with
            custom games, exclusive content, and endless fun.
          </p>
          ...
          <div className="mt-16">
            <div
              className="flex items-center space-x-2 text-orange-200 text-sm font-titan"
              style={{ fontWeight: "400" }}
            >
              <span>🔊</span>
      ...
      {/* Beta tag requested on Get Started page */}
      <div className="fixed bottom-3 right-4 z-20 text-orange-200/80 text-xs font-titan" style={{ fontWeight: "400" }}>
        Beta V1.1
      </div>
    </div>
  );
